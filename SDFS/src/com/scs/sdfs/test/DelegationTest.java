...
//		byte[] certData = token1.sourceCert.getEncoded();
//		System.out.println(certData.length);
//		CertificateFactory cf = CertificateFactory.getInstance("X.509");
//		Certificate certificate = (X509Certificate)cf.generateCertificate(new ByteArrayInputStream(certData));
//		System.out.println(certificate);
		
		String jsonCert = gson.toJson(token1.sourceCert);
		System.out.println(jsonCert);
		
		Certificate cert = gson.fromJson(jsonCert, Certificate.class);
